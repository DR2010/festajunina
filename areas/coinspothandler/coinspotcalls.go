...
func ListCoinsIhave(redisclient *redis.Client) []BalanceCrypto {
	...
	// apiserver, _ = redisclient.Get("APIdotnetIPAddress").Result()
	// urlrequest := apiserver + "/api/btcmarkets/getbyid?id=ALL"

	urlrequest := "https://www.coinspot.com.au/pubapi/latest"

	// apiserver = http://1.41.14.183:1803/
	// http://1.41.14.183:1803/api/btcmarkets/getonly
